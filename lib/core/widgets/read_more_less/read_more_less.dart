...
class ReadMoreLess extends StatelessWidget {
  ...
  bool exceedsMaxLines({
    ...
    final span = TextSpan(children: text, style: style);
      ...
      children: <Widget>[
        LayoutBuilder(
          builder: (context, size) {
            // استخدم نمطًا فعّالًا يدمج DefaultTextStyle مع textStyle المُمرّرة
            final effectiveStyle =
                DefaultTextStyle.of(context).style.merge(textStyle);

            return exceedsMaxLines(
                    context: context, style: effectiveStyle, constraints: size)
                ? ExpandableText(
                    text: text,
                ...
                : RichText(
                    text: TextSpan(children: text, style: effectiveStyle),
                    softWrap: true,
