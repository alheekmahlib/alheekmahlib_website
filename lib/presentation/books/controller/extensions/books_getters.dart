...
extension BooksGetters on BooksController {
  ...
  PageController get pageController {
    // أعِد نفس المتحكم المخزّن لتجنّب إنشاء متحكم جديد غير مرتبط بـ PageView
    return state.bookPageController;
  }
  ...
  //   final theme =
  //       Get.context != null ? Theme.of(Get.context!) : ThemeData.fallback();
  //   if (state.backgroundPickerColor.value == 0xfffaf7f3) {
  //     return theme.colorScheme.secondary;
  //   }
  //   if (ThemeController.instance.isDarkMode) {
  //     return theme.colorScheme.surfaceContainer;
  //   }
  //   return Color(state.backgroundPickerColor.value);
  // }
}
